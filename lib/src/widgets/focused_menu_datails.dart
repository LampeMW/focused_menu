...
class FocusedMenuDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (menuItems != null) {
      ...
      if (childOffset.dy >= (size.height / 2)) {
        bottomPopupOffset = size.height - childOffset.dy - menuOffset!;
      } else {
        topPopupOffset = childOffset.dy + childSize!.height + menuOffset!;
      }
      return Scaffold(
        backgroundColor: Colors.transparent,
        body: Stack(
          ...
          children: <Widget>[
            ...
            Positioned(
              ...
              // bottom: size.height - childOffset.dy,
              left: leftOffset,
              child: TweenAnimationBuilder(
                ...
                child: GestureDetector(
                  onTap: popupWidget!.onPressed != null
                      ? popupWidget!.onPressed!()
                      : null,
                  child: popupWidget!.child,
                ),
              ),
            ),
            if (toolbarActions != null)
